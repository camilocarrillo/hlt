...
float efficiency(TFile * theFile){
  TH1F * numerator = (TH1F*) (theFile->Get("higgsP_8"));
  TH1F * denominator = (TH1F*) (theFile->Get("higgsP_7"));
...
void higgs_hlt87(){
  ...
  TFile *_filetth15 = TFile::Open("tth_m150_8TeV/output.root");
   ...
   TFile *_filevbf0 = TFile::Open("vbf_m80_8TeV/output.root");
   TFile *_filevbf1 = TFile::Open("vbf_m85_8TeV/output.root");
